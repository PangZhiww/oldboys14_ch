...
# 吧模块当成脚本运行:
    # 你希望 某一段代码, 当被当做模块导入的时候, 不要执行
    #就把它写在　if __name__ == "__main__" 下面

# sys.path  一个自定义模块能否被导入, 就看 sys.path 列表中有没有这个模块所在的绝对路径
# import 模块名  # ModuleNotFoundError: No module named   sys.path中没有
